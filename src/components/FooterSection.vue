<template>
  <footer>
    <div class="footerMain">
      <div class="footerLogosDiv">
        <img
          src="@/assets/Images/FooterMainLogo.svg"
          alt="Footer Logo"
          class="footerLogo"
        />
        <div class="footerLogosTypes">
          <img
            src="@/assets/Images/SocialIcon1.svg"
            alt="Social Icon 1"
            class="footerSocialLogos"
          />
          <img
            src="@/assets/Images/SocialIcon2.svg"
            alt="Social Icon 2"
            class="footerSocialLogos"
          />
          <img
            src="@/assets/Images/SocialIcon3.svg"
            alt="Social Icon 3"
            class="footerSocialLogos"
          />
          <img
            src="@/assets/Images/SocialIcon4.svg"
            alt="Social Icon 4"
            class="footerSocialLogos"
          />
        </div>
      ...
      <div class="footerContact">
        <div class="footerContactTitle">Contact</div>
        <div class="location">
          <svg
          ...
          >
            <path
              d="M8.99991 10.6276C7.40241 10.6276 6.09741 9.33008 6.09741 7.72508C6.09741 6.12008 7.40241 4.83008 8.99991 4.83008C10.5974 4.83008 11.9024 6.12758 11.9024 7.73258C11.9024 9.33758 10.5974 10.6276 8.99991 10.6276ZM8.99991 5.95508C8.02491 5.95508 7.22241 6.75008 7.22241 7.73258C7.22241 8.71508 8.01741 9.51008 8.99991 9.51008C9.98241 9.51008 10.7774 8.71508 10.7774 7.73258C10.7774 6.75008 9.97491 5.95508 8.99991 5.95508Z"
              fill="#F5F5F5"
            />
            <path
              d="M9.00001 17.07C7.89001 17.07 6.77251 16.65 5.90251 15.8175C3.69001 13.6875 1.24501 10.29 2.16751 6.2475C3.00001 2.58 6.20251 0.9375 9.00001 0.9375C9.00001 0.9375 9.00001 0.9375 9.00751 0.9375C11.805 0.9375 15.0075 2.58 15.84 6.255C16.755 10.2975 14.31 13.6875 12.0975 15.8175C11.2275 16.65 10.11 17.07 9.00001 17.07ZM9.00001 2.0625C6.81751 2.0625 4.01251 3.225 3.27001 6.495C2.46001 10.0275 4.68001 13.0725 6.69001 15C7.98751 16.2525 10.02 16.2525 11.3175 15C13.32 13.0725 15.54 10.0275 14.745 6.495C13.995 3.225 11.1825 2.0625 9.00001 2.0625Z"
              fill="#F5F5F5"
            />
          </svg>
          <h4 class="footerlogoTitle">66 Road Broklyn Street, 600</h4>
        </div>
        ...
        <div class="contact">
          ...
          <h4 class="footerlogoTitle">(509) 562-1912</h4>
        </div>
        ...
        <div class="mail">
          ...
          >
            ...
            />
            <path
              d="M8.99983 9.65247C8.36983 9.65247 7.73234 9.45748 7.24484 9.05998L4.89733 7.18498C4.65733 6.98998 4.61234 6.63748 4.80734 6.39748C5.00234 6.15748 5.35484 6.11248 5.59484 6.30748L7.94233 8.18248C8.51233 8.63998 9.47983 8.63998 10.0498 8.18248L12.3973 6.30748C12.6373 6.11248 12.9973 6.14998 13.1848 6.39748C13.3798 6.63748 13.3423 6.99748 13.0948 7.18498L10.7473 9.05998C10.2673 9.45748 9.62983 9.65247 8.99983 9.65247Z"
              fill="#F5F5F5"
            />
          </svg>
          <h4 class="footerlogoTitle">contact@creativedesign.com</h4>
        </div>
      </div>

      <div class="Explore">
        <div class="exploreTitle">Explore</div>
        <div class="exploreDivs">About</div>
        <div class="exploreDivs">Our Team</div>
        <div class="exploreDivs">Shop</div>
        <div class="exploreDivs">Career</div>
        <div class="exploreDivs">Blog</div>
      </div>

      <div class="SubscribetoourNewsletter">
        <div class="SubrcribeNewsTitle">Subscribe to our Newsletter</div>
        <div class="footermail">Email*</div>
        <input
          type="email"
        ...
        <button class="footerButton" @click="handleSubscribe">
          Subscribe
          <img
            src="@/assets/vuesax/outline/RightArrowIcon1.svg"
            alt="arrow"
            class="buttonArrow"
          />
        </button>
